                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                    ...
                                    <div id="carouselExampleIndicators1" class="carousel slide my-4" data-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <img class="d-block img-fluid product-image" style="height: 400px" src="images/products-page/piłka1_1.jpg" alt="slide1">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block img-fluid" style="height: 400px" src="images/products-page/piłka1_2.jpg" alt="slide2">
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title"><a href="#">Piłka 1</a></h4>
                                        <h5 class="product-price">399,00 PLN</h5>
                                        <ul class="card-text">
                                            <li>Średnica: </li>
                                            <li>Przeznaczenie:</li>
                                            <li>Kod producenta: ABC-123</li>
                                        </ul>
                                    </div>
                                <a href="page_balls.php?pro_id=4" class="btn btn-success">Dodaj do koszyka <img src="icons/page-icons/local_grocery_store-24px.png" alt=""/></a>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                    ...
                                    <div id="carouselExampleIndicators2" class="carousel slide my-4" data-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <img class="d-block img-fluid product-image" style="height: 400px" src="images/products-page/piłka2_1.jpg" alt="slide1">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block img-fluid" style="height: 400px" src="images/products-page/piłka2_2.jpg" alt="slide2">
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title product-name"><a href="#">Piłka</a></h4>
                                ...
                                <a href="page_balls.php?pro_id=5" class="btn btn-success">Dodaj do koszyka <img src="icons/page-icons/local_grocery_store-24px.png" alt=""/></a>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                    ...
                                    <div id="carouselExampleIndicators3" class="carousel slide my-4" data-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <img class="d-block img-fluid product-image" style="height: 400px" src="images/products-page/piłka3_1.jpg" alt="slide1">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block img-fluid" style="height: 400px" src="images/products-page/piłka3_2.jpg" alt="slide2">
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title product-name"><a href="#">Piłka 3</a></h4>
                                ...
                                <a href="page_balls.php?pro_id=6" class="btn btn-success">Dodaj do koszyka <img src="icons/page-icons/local_grocery_store-24px.png" alt=""/></a>
